    ...
    return (
        <Grid container style={{ marginTop: 20 }} justifyContent="center" alignItems="center">
            <Grid xs={11} sm={11} item style={{ paddingRight: 16 }}>
                <TextField placeholder="Add Todo here" fullWidth value={item.title} onChange={onInputChange} onKeyDown={enterKeyEventHandler}/>
            </Grid>
            <Grid>
